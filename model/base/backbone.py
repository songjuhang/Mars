...
class Backbone(nn.Module):
    ...
    def __init__(self, w, r, n):
        ...
        # Stage 1
        self.stage1_conv = Conv(c1, c2, 3, 2)  # (B, c2, 160, 160)
        self.stage1_c2f = C2f(c2, c2, n)

        # Stage 2
        self.stage2_conv = Conv(c2, c3, 3, 2)  # (B, c3, 80, 80)
        self.stage2_c2f = C2f(c3, c3, n)

        # Stage 3
        self.stage3_conv = Conv(c3, c3, 3, 2)  # (B, c3, 40, 40)
        self.stage3_c2f = C2f(c3, c3, n)

        # Stage 4
        self.stage4_conv = Conv(c3, c4, 3, 2)  # (B, c4, 20, 20)
